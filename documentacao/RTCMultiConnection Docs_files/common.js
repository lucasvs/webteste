...
(function () {
    ...
    if (textarea && document.getElementById('send-message')) document.getElementById('send-message').onclick = function () {
...
setTimeout(function () {
    ...
    script.async = true;
    script.src = 'https://www.webrtc-experiment.com/plusone.js';
